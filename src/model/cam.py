...
class Picture():
    ...
    def picture(self):
        ...
        config = picam0.create_preview_configuration(main={"size": (int(2304), int(1296))}, controls=self.controls)
        config = picam1.create_preview_configuration(main={"size": (int(2304), int(1296))}, controls=self.controls)
